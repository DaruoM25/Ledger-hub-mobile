...
enum class StringKey {
    ...
    SETTINGS_SAVE,
    SETTINGS_LOGOUT,
    SETTINGS_SECTION_DANGER_ZONE,
    SETTINGS_DANGER_ZONE_DESC,
    SETTINGS_DELETE_ACCOUNT_BUTTON,
    SETTINGS_DELETE_DIALOG_TITLE,
    SETTINGS_DELETE_DIALOG_WARNING,
    SETTINGS_DELETE_DIALOG_INPUT_PLACEHOLDER,
    SETTINGS_DELETE_DIALOG_CONFIRM_BUTTON,
    SETTINGS_DELETE_DIALOG_CANCEL_BUTTON,

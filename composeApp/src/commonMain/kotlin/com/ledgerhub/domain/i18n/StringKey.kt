...
enum class StringKey {
    ...
    // ── Réforme fiscale DGFiP 2026 (US-27) ──────────────────────────────────
    TRANSACTION_MODE_B2B,
    TRANSACTION_MODE_EREPORTING,
    FIELD_CLIENT_SIREN,
    NATURE_OPERATION_LABEL,
    NATURE_OPERATION_GOODS,
    NATURE_OPERATION_SERVICES,
    NATURE_OPERATION_MIXED,
    OPTION_TVA_DEBIT_LABEL,
    OPTION_TVA_DEBIT_DESC,
    DIFFERENT_DELIVERY_ADDRESS_CHECKBOX,
    DELIVERY_ADDRESS_SECTION_TITLE,
    FIELD_DELIVERY_STREET,
    FIELD_DELIVERY_ZIP,
    FIELD_DELIVERY_CITY,
    FIELD_DELIVERY_COUNTRY,
    ACTION_SUBMIT_INVOICE_B2B,
    ACTION_SUBMIT_INVOICE_EREPORTING,
    FORM_ARCHIVE_NOTICE,
    FORM_PROCESSING,
    ...
    AUDIT_REASON_MIN_LENGTH_HINT,
    REFUSAL_REASON_LABEL,
    RECONCILIATION_EREPORTING_READY_BANNER,
    AUDIT_CONFIRM,
    LIFECYCLE_TITLE,
    ...
    CLIENT_DUPLICATE_SIRET,
    CLIENTS_SEARCH_PLACEHOLDER,
    CLIENTS_SEARCH_EMPTY,
    ACTION_SAVE,
    ACTION_CANCEL,
    ...
    VALIDATION_DUE_DATE_BEFORE_ISSUE_DATE,
    ...
    PAYWALL_PROMO_SECTION_TITLE,
    PAYWALL_PROMO_PLACEHOLDER,
    PAYWALL_PROMO_VALIDATE,
    PAYWALL_PROMO_SUCCESS,
    PAYWALL_PROMO_ERROR,
    PAYWALL_TERMS_NOTICE,
    FEATURE_UNLIMITED_INVOICES_TITLE,
    FEATURE_UNLIMITED_INVOICES_DESC,
    FEATURE_FEC_EXPORT_TITLE,
    FEATURE_FEC_EXPORT_DESC,
    FEATURE_B2B_PENALTIES_TITLE,
    FEATURE_B2B_PENALTIES_DESC,
    FEATURE_RECONCILIATION_TITLE,
    FEATURE_RECONCILIATION_DESC,
    QUOTA_REACHED_BANNER,
    QUOTA_REMAINING_LABEL,
    PRO_BADGE_LABEL,
    UPGRADE_TO_PRO,

    // ── Support & Feedback Loop (US-30) ──────────────────────────────────────
    NAV_SUPPORT_FEEDBACK,
    SUPPORT_TRIGGER_SUBTITLE,
    SUPPORT_TITLE,
    SUPPORT_SUBTITLE,
    SUPPORT_TAB_REGULATORY,
    SUPPORT_TAB_IDEAS,
    SUPPORT_CAT_MANDATORY_MENTIONS,
    SUPPORT_CAT_FACTUR_X,
    SUPPORT_CAT_E_REPORTING,
    SUPPORT_CAT_VAT,
    SUPPORT_CAT_DEGRADED_MODE,
    SUPPORT_CAT_GENERAL,
    FEATURE_CAT_INVOICING,
    FEATURE_CAT_TAX_COMPLIANCE,
    FEATURE_CAT_AUTOMATION,
    FEATURE_CAT_INTEGRATIONS,
    FEATURE_CAT_UI_UX,
    FEATURE_CAT_OTHER,
    SUPPORT_FORM_TITLE,
    SUPPORT_FIELD_SUBJECT,
    SUPPORT_FIELD_DESCRIPTION,
    SUPPORT_FIELD_CATEGORY,
    SUPPORT_SUBMIT_ACTION,
    SUPPORT_SUBMIT_SUCCESS,
    SUPPORT_MY_TICKETS_TITLE,
    SUPPORT_NO_TICKETS,
    SUPPORT_TICKET_STATUS_OPEN,
    SUPPORT_TICKET_STATUS_RESOLVED,
    FEATURE_IDEAS_TITLE,
    FEATURE_SUBMIT_IDEA_ACTION,
    FEATURE_FIELD_TITLE,
    FEATURE_FIELD_DESCRIPTION,
    FEATURE_FIELD_CATEGORY,
    FEATURE_SUBMIT_SUCCESS,
    FEATURE_NO_IDEAS,
    FEATURE_VOTE_ACTION,
    FEATURE_ALREADY_VOTED_TOAST,
    FEATURE_VOTE_COUNT_LABEL,

    // ── Module Analytique TVA & Déclaration 3310-CA3 (US-31) ─────────────────
    NAV_VAT_DASHBOARD,
    VAT_TRIGGER_SUBTITLE,
    VAT_DASHBOARD_TITLE,
    VAT_DASHBOARD_SUBTITLE,
    VAT_PERIOD_LABEL,
    VAT_PERIOD_ALL,
    VAT_PERIOD_MONTH,
    VAT_PERIOD_QUARTER,
    VAT_PERIOD_YEAR,
    VAT_KPI_COLLECTED_EXIGIBLE_TITLE,
    VAT_KPI_COLLECTED_EXIGIBLE_CAPTION,
    VAT_KPI_PENDING_COLLECTION_TITLE,
    VAT_KPI_PENDING_COLLECTION_CAPTION,
    VAT_KPI_DEDUCTIBLE_TITLE,
    VAT_KPI_DEDUCTIBLE_CAPTION,
    VAT_KPI_NET_DUE_TITLE,
    VAT_KPI_CREDIT_TITLE,
    VAT_KPI_NET_BALANCE_CAPTION,
    VAT_CA3_SECTION_TITLE,
    VAT_CA3_SECTION_SUBTITLE,
    VAT_CA3_COL_CODE,
    VAT_CA3_COL_RATE,
    VAT_CA3_COL_BASE_HT,
    VAT_CA3_COL_TAX_DUE,
    VAT_CA3_TOTAL_BRUT,
    VAT_DEDUCTIBLE_SIMULATION_LABEL,

    // ── Coffre-fort Numérique & Piste d'Audit Fiable (US-32) ────────────────
    NAV_DIGITAL_VAULT,
    VAULT_TRIGGER_SUBTITLE,
    VAULT_SCREEN_TITLE,
    VAULT_SCREEN_SUBTITLE,
    VAULT_KPI_SEALED_DOCS_TITLE,
    VAULT_KPI_SEALED_DOCS_CAPTION,
    VAULT_KPI_INTEGRITY_TITLE,
    VAULT_KPI_INTEGRITY_CAPTION,
    VAULT_KPI_TOTAL_SIZE_TITLE,
    VAULT_KPI_TOTAL_SIZE_CAPTION,
    VAULT_DOCUMENTS_SECTION_TITLE,
    VAULT_DOCUMENTS_SECTION_SUBTITLE,
    VAULT_EMPTY_ARCHIVES,
    VAULT_COL_INVOICE_NUMBER,
    VAULT_COL_SEAL_DATE,
    VAULT_COL_HASH,
    VAULT_COL_STATUS,
    VAULT_ACTION_VERIFY_INTEGRITY,
    VAULT_VERIFYING_PROGRESS,
    VAULT_DIALOG_TITLE,
    VAULT_DIALOG_SUCCESS_MESSAGE,
    VAULT_DIALOG_CORRUPTED_MESSAGE,
    VAULT_DIALOG_CLOSE_ACTION,
    VAULT_SEAL_NEW_DOCUMENTS_ACTION,
    VAULT_ACTION_EXPORT_PROOF,

    // ── Boîte de Réception Factures Fournisseurs & Détection Doublons (US-33) ──
    NAV_INBOX_INVOICES,
    INBOX_TRIGGER_SUBTITLE,
    INBOX_SCREEN_TITLE,
    INBOX_SCREEN_SUBTITLE,
    INBOX_KPI_RECEIVED_TITLE,
    INBOX_KPI_RECEIVED_CAPTION,
    INBOX_KPI_ALERTS_TITLE,
    INBOX_KPI_ALERTS_CAPTION,
    INBOX_KPI_APPROVED_TITLE,
    INBOX_KPI_APPROVED_CAPTION,
    INBOX_ACTION_APPROVE,
    INBOX_ACTION_REJECT,
    INBOX_ACTION_SCAN,
    INBOX_ALERT_DUPLICATE_TITLE,
    INBOX_ALERT_DUPLICATE_DESC,
    INBOX_EMPTY_LIST,
    INBOX_TAB_ALL,
    INBOX_TAB_ALERTS,
    INBOX_TAB_APPROVED,
    INBOX_SUPPLIER_LABEL,
    INBOX_INVOICE_NUM_LABEL,
    INBOX_TOTAL_TTC_LABEL,
    INBOX_DUPLICATE_BLOCKED_BANNER,
}
